...
describe('--info and --stacktrace', () => {
    describe('will be created', () => {
        it('when gradle.properties does not exist', async () => {
            ...
            expect(fs.readFileSync(path.resolve(emptyGradleHome, 'gradle.properties'), 'utf-8')).toBe(
    ...
    describe('will be added', () => {
        it('and gradle.properties does exists', async () => {
            ...
            expect(fs.readFileSync(path.resolve(existingGradleHome, 'gradle.properties'), 'utf-8')).toBe(
